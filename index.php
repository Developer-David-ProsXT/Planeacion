                ...
                <form action="create_planeacion.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" name="category_periodo">
                            <?php
                                include 'config.php';
                                $query = mysqli_query($mysql, "select id, nombre from Periodos;");
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlSelect1">Select the group</label>
                        <select class="form-control" name="category_grupo">
                            <?php
                                include 'config.php';
                                $query = mysqli_query($mysql, "select id, nombre from Grupos;");
                    ...
                    <div class="form-group">
                        ...
                        <button type="button" class="btn btn-primary btn-lg btn-block" onclick="location.href='existing.php'">Existing catalogs</button>
                    </div>
                </form>
            </div>
        </div>
